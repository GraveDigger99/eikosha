(() => {
    ...
    function menuInit() {
        const clickItem = document.querySelector(".menu-catalog__icon");
        const closeItem = document.querySelector(".menu-catalog__close");
        if (clickItem) clickItem.addEventListener("click", (function() {
            document.documentElement.classList.add("catalog-open");
        }));
        if (closeItem) closeItem.addEventListener("click", (function() {
    ...
    function initSliders() {
        if (document.querySelector(".mainscreen-mobile__slider")) new core(".mainscreen-mobile__slider", {
